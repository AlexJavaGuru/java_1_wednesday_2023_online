...
public class DayOfTheWeekDetectorTest1 {
    public static void main(String[] args) {
        DayOfTheWeekDetectorTest1 test = new DayOfTheWeekDetectorTest1();
    ...
    public void shouldReturnFalse() {
        ...
        checkTestResult("Not correct day number".equals(dayOfTheWeek), "False");
    }
